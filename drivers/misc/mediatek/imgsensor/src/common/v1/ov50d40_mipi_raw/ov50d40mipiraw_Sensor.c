...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 760800000,//1902Mbps/lane 1902*4lane/10bit
	},
    ...
    .custom1 = {//1080p@60fps
		...
		.mipi_data_lp2hs_settle_dc = 85,//unit , ns
		.max_framerate = 600,
		.mipi_pixel_rate = 540000000,//1350Mbps/lane
	},
  .custom2 = {
		.pclk = 99960000,
		.linelength = 425,
...
#if REMOSAIC_SUPPORT
	{ 8192,  6144,  0,  0,  8192,  6144,  4096,  3072,  0000,  0000,  4096,  3072,  0,  0,  4096,  3072},	/*custom3 remosaic*/
#else
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[3]=
{
	/* Preview mode setting */
	 {0x02, //VC_Num
	  ...
	  0x00, 0x2b, 4096, 3072,	// VC0 Maybe image data?
	  0x00, 0x00, 0x0000, 0x0000,	// VC1 MVHDR
	  0x01, 0x30, 1240, 760,   // VC2 PDAF //248*4*10/8 190*4 need 4byte align 4d8
	...
	/* Capture mode setting */ 
	 {0x02, //VC_Num
	  ...
	  0x00, 0x2b, 4096, 3072,	// VC0 Maybe image data?
	  0x00, 0x00, 0x0000, 0x0000,	// VC1 MVHDR
	  0x01, 0x30, 1240, 760,   // VC2 PDAF //248*4*10/8 190*4 need 4byte align
	  0x00, 0x00, 0x0000, 0x0000},	// VC3 ??
	/* Video mode setting */
	 {0x02, //VC_Num
	  0x0a, //VC_PixelNum	
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	 ...
	 .i4BlockNumX = 248,//496*8=3968+64*2=4096
	 .i4BlockNumY = 190,//380*8=3040+16*2=3072
	 .iMirrorFlip = 0,
	 .i4Crop = {
...
{
	LOG_INF("preview_setting RES_4096x3072_30fps\n");
	ov50d40_table_write_cmos_sensor(
		addr_data_pair_4096x3072_ov50d40,
		sizeof(addr_data_pair_4096x3072_ov50d40) / sizeof(kal_uint16));
}
...
static void capture_setting(kal_uint16 currefps)
{
	...
	ov50d40_table_write_cmos_sensor(
		addr_data_pair_4096x3072_ov50d40,
		sizeof(addr_data_pair_4096x3072_ov50d40) /
		sizeof(kal_uint16));
}

static void normal_video_setting(kal_uint16 currefps)
{
	LOG_INF("normal_video_setting RES_4096x3072_zsl_30fps\n");
	ov50d40_table_write_cmos_sensor(
		addr_data_pair_4096x3072_ov50d40,
		sizeof(addr_data_pair_4096x3072_ov50d40) /
		sizeof(kal_uint16));
...
static void slim_video_setting(void)
{
	...
	ov50d40_table_write_cmos_sensor(
		addr_data_pair_3840x2160_ov50d40,
		sizeof(addr_data_pair_3840x2160_ov50d40) /
		sizeof(kal_uint16));
}
...
{
  LOG_INF("custom1_setting RES_1920x1080_60fps\n");
  ov50d40_table_write_cmos_sensor(addr_data_pair_1920x1080_60fps_ov50d40,
		sizeof(addr_data_pair_1920x1080_60fps_ov50d40) / sizeof(kal_uint16));
}	/*	custom1_setting  */

static void custom2_setting(void)
{
  LOG_INF("E\n");
  ov50d40_table_write_cmos_sensor(addr_data_pair_4096x3072_ov50d40,
		sizeof(addr_data_pair_4096x3072_ov50d40) / sizeof(kal_uint16));
}	/*	custom2_setting  */
