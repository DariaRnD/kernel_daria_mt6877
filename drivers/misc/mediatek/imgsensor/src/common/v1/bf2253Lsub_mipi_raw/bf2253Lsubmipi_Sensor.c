...
#include "bf2253Lsubmipi_Sensor.h"
...
#define PFX "bf2253Lsub_camera_sensor"
#define LOG_1 LOG_INF("BF2253LSUB, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
kal_bool BF2253LSUBDuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = BF2253LSUB_MIPI_SENSOR_ID,
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	BF2253LSUBDuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
...
static kal_uint32 bf2253Lsub_ana_gain_table[] = {
     1024,	1088,	 1150,	1214, 
     1277,	1342,	 1403,	1468, 
     1527,	1594,	 1652,	1716, 
     1775,	1839,	 1897,	1960, 
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
	 if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL
	                            || *(feature_data + 0) == 0) {
	        *(feature_data + 0) =
	            sizeof(bf2253Lsub_ana_gain_table)/sizeof(kal_uint32);
    } else {
        memcpy((void *)(uintptr_t) (*(feature_data + 1)),
        (void *)bf2253Lsub_ana_gain_table,
        sizeof(bf2253Lsub_ana_gain_table)/sizeof(kal_uint32));
    }	
		break;		
...
UINT32 BF2253LSUB_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
