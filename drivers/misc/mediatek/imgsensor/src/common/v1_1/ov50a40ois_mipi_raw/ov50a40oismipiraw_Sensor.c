 ...
 * Filename:
 * ---------
 *   OV50A40OIS_REAR_rear_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "ov50a40oismipiraw_Sensor.h"
#include "ov50a40ois_Sensor_setting.h"
#define PFX "OV50A40OIS_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV50A40OIS_SENSOR_ID,
...
#if OV50A40OIS_MIRROR_FLIP_ENABLE
	#if REMOSAIC_SUPPORT
...
static kal_uint16 ov50a40ois_table_write_cmos_sensor(
...
static void sensor_init(void)
{
	...
	mdelay(10);
	LOG_INF("sensor_init\n");
	ov50a40ois_table_write_cmos_sensor(
		addr_data_pair_init_ov50a40ois,
		sizeof(addr_data_pair_init_ov50a40ois) / sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	...
	ov50a40ois_table_write_cmos_sensor(
		addr_data_pair_preview_ov50a40ois,
		sizeof(addr_data_pair_preview_ov50a40ois) / sizeof(kal_uint16));
}
...
static void capture_setting(kal_uint16 currefps)
{
	...
	ov50a40ois_table_write_cmos_sensor(
		addr_data_pair_capture_ov50a40ois,
		sizeof(addr_data_pair_capture_ov50a40ois) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	ov50a40ois_table_write_cmos_sensor(
		addr_data_pair_video_ov50a40ois,
		sizeof(addr_data_pair_video_ov50a40ois) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	...
	ov50a40ois_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov50a40ois,
		sizeof(addr_data_pair_hs_video_ov50a40ois) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	...
	ov50a40ois_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov50a40ois,
		sizeof(addr_data_pair_slim_video_ov50a40ois) /
		sizeof(kal_uint16));
}
...
{
  LOG_INF("E\n");
  ov50a40ois_table_write_cmos_sensor(addr_data_pair_custom1_ov50a40ois,
		sizeof(addr_data_pair_custom1_ov50a40ois) / sizeof(kal_uint16));
}	/*	custom1_setting  */

static void custom2_setting(void)
{
  LOG_INF("E\n");
  ov50a40ois_table_write_cmos_sensor(addr_data_pair_custom2_ov50a40ois,
		sizeof(addr_data_pair_custom2_ov50a40ois) / sizeof(kal_uint16));
}	/*	custom2_setting  */
...
static void custom3_setting(void)
{
  LOG_INF("E\n");
#if REMOSAIC_SUPPORT
  ov50a40ois_table_write_cmos_sensor(addr_data_pair_custom3_ov50a40ois,
		sizeof(addr_data_pair_custom3_ov50a40ois) / sizeof(kal_uint16));
#else
  ov50a40ois_table_write_cmos_sensor(addr_data_pair_capture_ov50a40ois,
		sizeof(addr_data_pair_capture_ov50a40ois) / sizeof(kal_uint16));
#endif
}	/*	custom3_setting  */
static void custom4_setting(void)
{
  LOG_INF("E\n");
  ov50a40ois_table_write_cmos_sensor(addr_data_pair_custom4_ov50a40ois,
		sizeof(addr_data_pair_custom4_ov50a40ois) / sizeof(kal_uint16));
}	/*	custom4_setting  */
static void custom5_setting(void)
{
  LOG_INF("E\n");
  ov50a40ois_table_write_cmos_sensor(addr_data_pair_custom5_ov50a40ois,
		sizeof(addr_data_pair_custom5_ov50a40ois) / sizeof(kal_uint16));
}	/*	custom5_setting  */
