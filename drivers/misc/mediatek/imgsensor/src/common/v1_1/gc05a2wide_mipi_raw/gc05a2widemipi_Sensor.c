...
#include "gc05a2widemipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc05a2wide_camera_sensor"
#define LOG_1 LOG_INF("GC05A2WIDE, MIPI 2LANE\n")
/****************************   Modify end    *******************************************/
#define GC05A2WIDE_DEBUG                0
#if GC05A2WIDE_DEBUG
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC05A2WIDE_SENSOR_ID,
...
//#if GC05A2WIDE_MIRROR_NORMAL
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr,
//#elif GC05A2WIDE_MIRROR_H
//	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,
//#elif GC05A2WIDE_MIRROR_V
//	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,
//#elif GC05A2WIDE_MIRROR_HV
...
kal_uint16 gc05a2wide_init_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
static kal_uint16 gc05a2wide_1296x972_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
static kal_uint16 gc05a2wide_2592x1944_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
static kal_uint16 gc05a2wide_1280x720_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
static void gc05a2wide_stream_on(void)
{
	write_cmos_sensor_8bit(0x0100, 0x01);
}

static void gc05a2wide_stream_off(void)
{
...
{
	table_write_cmos_sensor(gc05a2wide_init_addr_data,
		sizeof(gc05a2wide_init_addr_data)/sizeof(kal_uint16));
}

static void preview_setting(void)
{
	gc05a2wide_stream_off();
	table_write_cmos_sensor(gc05a2wide_1296x972_addr_data,
		sizeof(gc05a2wide_1296x972_addr_data)/sizeof(kal_uint16));
	gc05a2wide_stream_on();
}

static void capture_setting(void)
{
	gc05a2wide_stream_off();
	table_write_cmos_sensor(gc05a2wide_2592x1944_addr_data,
		sizeof(gc05a2wide_2592x1944_addr_data)/sizeof(kal_uint16));
	gc05a2wide_stream_on();
}
...
{
	gc05a2wide_stream_off();
	table_write_cmos_sensor(gc05a2wide_1280x720_addr_data,
		sizeof(gc05a2wide_1280x720_addr_data)/sizeof(kal_uint16));
	gc05a2wide_stream_on();
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc05a2wide_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			pr_debug("[gc05a2wide_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc05a2wide_camera_sensor]open:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			pr_debug("[gc05a2wide_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
