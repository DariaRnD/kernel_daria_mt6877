...
UINT32 IMX520_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 IMX351RT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 OV9281_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc); //drv add by lipengpeng 
/*S5K*/
...
UINT32 IMX686RT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
//drv add by lipengpeng 20231010 start 
UINT32 S5KHP3SP_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//drv add by lipengpeng 20231010 end 
