...
#include "imx6862mipiraw_Sensor.h"
...
#define PFX "IMX6862_camera_sensor"

#define DEVICE_VERSION_IMX6862     "imx6862"
...
#define LRC_SQC_LOG(format, args...)   
#endif
//extern void IMX6862_MIPI_update_awb(kal_uint8 i2c_write_id);
...
static BYTE imx6862_qsc_data[DATA_SIZE] = { 0 };
//extern bool imx6862_read_otp_qsc(BYTE* data);

#define LRC_SIZE 504 //384
static BYTE imx6862_lrc_data[LRC_SIZE] = { 0 };
//extern bool imx6862_read_otp_lrc(BYTE* data);
static unsigned char LRC_SQC_readed = 0;
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX6862_SENSOR_ID,
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[3] = {
	...
	{0x05, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 ...
	 0x00, 0x30, 0x059C, 0x06b8, 0x00, 0x00, 0x0000, 0x0000}, /*VC2:Y HIST(3HDR), VC3:AE HIST(3HDR)*/ 
	...
	{0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 ...
	 0x00, 0x30, 0x059C, 0x06b8, 0x00, 0x00, 0x0000, 0x0000},
	/* Video mode setting */
...
#define IMX6862MIPI_MaxGainIndex (223)
kal_uint16 IMX6862MIPI_sensorGainMapping[IMX6862MIPI_MaxGainIndex][2] ={
	{72,114},
	{76,162},
	{80,205},
	{84,244},
...
static bool read_imx6862_eeprom(kal_uint16 addr, BYTE *data, int size)
{
	int i = 0;
	int offset = addr;
...
unsigned int read_imx6862_LRC( BYTE *data )
{
	//0x0D51   ---0x0F48   504
	read_imx6862_eeprom(0x0D63,data,504);
	return 504;
}

unsigned int read_imx6862_SQC( BYTE *data )
{
	//0x0F4B   ---0x1B1A  3024
	read_imx6862_eeprom(0x0F5D,data,3024);
	return 3024;
}

//if((LRC_SIZE == read_imx686_LRC(imx686_lrc_data)) && (DATA_SIZE == read_imx686_SQC(imx686_qsc_data)))

//prize hjw for  lrc   QBC end
static void imx6862_get_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx6862_set_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	for (i = 0; i < IMX6862MIPI_MaxGainIndex; i++) {
		if(gain <= IMX6862MIPI_sensorGainMapping[i][0]){
			break;
		}
	}
	if(gain != IMX6862MIPI_sensorGainMapping[i][0])
		LOG_INF("Gain mapping don't correctly:%d %d \n", gain, IMX6862MIPI_sensorGainMapping[i][0]);
	return IMX6862MIPI_sensorGainMapping[i][1];
}
...
static kal_uint16 imx6862_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static void write_imx6862_LRC_Data(void)
{
	kal_uint16 i;	

	for (i = 0; i < 252; i++) {
		write_cmos_sensor_8(0x7B00 + i, imx6862_lrc_data[i]);
		LRC_SQC_LOG("imx6862_lrc_data[%d] = 0x%x\n", i, imx6862_lrc_data[i]);
	}
	
	for (i = 252; i < LRC_SIZE; i++) {
		write_cmos_sensor_8(0x7C00 + i, imx6862_lrc_data[i]);
		LRC_SQC_LOG("imx6862_lrc_data[%d] = 0x%x\n", i, imx6862_lrc_data[i]);
	}
}

static void write_imx6862_QSC_Data(void)
{
	kal_uint16 i;	

	for (i = 0; i < DATA_SIZE; i++) {
		write_cmos_sensor_8(0xCA00 + i, imx6862_qsc_data[i]);
		LRC_SQC_LOG("imx6862_qsc_data[%d] = 0x%x\n", i, imx6862_qsc_data[i]);
	}
}

kal_uint16 addr_data_pair_init_imx6862_Ver6[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x33F0, 0x01,
	0x33F1, 0x08,
...
kal_uint16 addr_data_pair_preview_imx6862[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x27,
...
kal_uint16 addr_data_pair_custom3_imx6862[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x3B,
...
kal_uint16 addr_data_pair_custom2_imx6862[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x27,
...
kal_uint16 addr_data_pair_capture_imx6862[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x27,
...
kal_uint16 addr_data_pair_hs_video_imx6862[] = {
	0x0112,0x0A,
	0x0113,0x0A,
	0x0114,0x03,
	0x0342,0x15,
...
kal_uint16 addr_data_pair_slim_video_imx6862[] = {
	0x0112,0x0A,
	0x0113,0x0A,
	0x0114,0x03,
	0x0342,0x15,
...
{
	LOG_INF("E init\n");
	imx6862_table_write_cmos_sensor(addr_data_pair_init_imx6862_Ver6,
		sizeof(addr_data_pair_init_imx6862_Ver6) / sizeof(kal_uint16));
	LOG_INF("L\n");
} /*	sensor_init  */
...
static void preview_setting(void)
{
	...
	imx6862_table_write_cmos_sensor(addr_data_pair_preview_imx6862,
         sizeof(addr_data_pair_preview_imx6862) / sizeof(kal_uint16));  
...
static void capture_setting(kal_uint16 currefps, kal_bool stream_on)
{
	...
	imx6862_table_write_cmos_sensor(addr_data_pair_capture_imx6862,
		sizeof(addr_data_pair_capture_imx6862) / sizeof(kal_uint16));
...
{
	LOG_INF("E\n");
	imx6862_table_write_cmos_sensor(addr_data_pair_hs_video_imx6862,
		sizeof(addr_data_pair_hs_video_imx6862) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
	LOG_INF("E\n");
	imx6862_table_write_cmos_sensor(addr_data_pair_slim_video_imx6862,
		sizeof(addr_data_pair_slim_video_imx6862) / sizeof(kal_uint16));
}
...
static void custom1_setting(void)
{
	...
	LOG_INF("E\n");
#if 0
	imx6862_table_write_cmos_sensor(addr_data_pair_custom1_imx6862,
		sizeof(addr_data_pair_custom1_imx6862) / sizeof(kal_uint16));
#else
	preview_setting();
#endif
}
...
static void custom2_setting(void)
{
	...
	LOG_INF("E\n");
	imx6862_table_write_cmos_sensor(addr_data_pair_custom2_imx6862,
		sizeof(addr_data_pair_custom2_imx6862) / sizeof(kal_uint16));
}
...
static void custom3_setting(void)
{
	...
	LOG_INF("E\n");
	imx6862_table_write_cmos_sensor(addr_data_pair_custom3_imx6862,
		sizeof(addr_data_pair_custom3_imx6862) / sizeof(kal_uint16));
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	//		module_id = read_eeprom_module_id(0x0001);
            *sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
			...
			printk("lpp--imx6862-gpio_get_value(24)=%d (26)=%d sensor_id=0x%x module_id=0x%x\n",gpio_get_value(70),gpio_get_value(72),*sensor_id,module_id);
			if( (gpio_get_value(70)==1) /*|| (module_id!=0x49)*/ )
			{
				*sensor_id = 0xFFFFFFFF;
				return ERROR_SENSOR_CONNECT_FAIL;
			}
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(LRC_SQC_readed != 1) {
					...
					if((LRC_SIZE == read_imx6862_LRC(imx6862_lrc_data)) && (DATA_SIZE == read_imx6862_SQC(imx6862_qsc_data)))
						LRC_SQC_readed = 1;
					LOG_INF("lhh Read LRC,SQC end LRC_SQC_readed=%d \n", LRC_SQC_readed);
				}
                module_id = read_eeprom_module_id(0x0001);
                printk("lpp--imx68622-gpio_get_value(24)=%d (26)=%d sensor_id=0x%x module_id=0x%x\n",gpio_get_value(70),gpio_get_value(72),*sensor_id,module_id);
...
static kal_uint32 open(void)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
			gpio_direction_input(24+46);
			gpio_direction_input(26+46);
			//module_id = read_eeprom_module_id(0x1BD3);
            sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
                    | read_cmos_sensor_8(0x0017))+2;
			printk("lpp--imx686-gpio_get_value(24)=%d (26)=%d sensor id: 0x%x \n",gpio_get_value(70),gpio_get_value(72),sensor_id);
			if( (gpio_get_value(70)==1)/*||(module_id!=0x49)*/)
			{
				return ERROR_SENSOR_CONNECT_FAIL;
			}
	...
	if(LRC_SQC_readed){
		LOG_INF("lhh write write_imx6862_LRC_Data start \n");
		write_imx6862_LRC_Data();
		LOG_INF("lhh write write_imx6862_LRC_Data end \n");
	}
	
	//IMX6862_MIPI_update_awb(imgsensor.i2c_write_id);
						  ...
						  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	if(LRC_SQC_readed){
		LOG_INF("lhh write write_imx6862_QSC_Data start \n");
		write_imx6862_QSC_Data();
		LOG_INF("lhh write write_imx6862_QSC_Data end \n");
	}
...
static void imx6862_set_lsc_reg_setting(kal_uint8 index, kal_uint16 *regDa, MUINT32 regNum)
{
...
static void set_imx6862_ATR(kal_uint16 LimitGain, kal_uint16 LtcRate, kal_uint16 PostGain)
{


}

static kal_uint32 imx6862_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
							 ...
							 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO:
		...
		case SENSOR_FEATURE_SET_HDR_ATR:
			...
			set_imx6862_ATR((UINT16)*feature_data,
						(UINT16)*(feature_data + 1),
						(UINT16)*(feature_data + 2));
			break;
		...
		case SENSOR_FEATURE_SET_AWB_GAIN:
			imx6862_awb_gain(pSetSensorAWB);
			break;
		case SENSOR_FEATURE_SET_LSC_TBL:
			{
				kal_uint8 index = *(((kal_uint8 *)feature_para) + (*feature_para_len));

				imx6862_set_lsc_reg_setting(index, feature_data_16, (*feature_para_len)/sizeof(UINT16));
			}
			break;
		...
		case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
			pr_debug("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
				(*feature_para_len));
			imx6862_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
						   , feature_data_16);
			break;			
		case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
			pr_debug("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
				(*feature_para_len));
			imx6862_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
						   , feature_data_16);
			break;
