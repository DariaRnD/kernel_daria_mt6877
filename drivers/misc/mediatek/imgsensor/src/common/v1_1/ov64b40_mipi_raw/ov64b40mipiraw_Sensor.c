...
// #define OV64B40_MODULE_ID_OFFSET  0x0001
//static kal_uint16 read_module_id_ov64b4040(void)
//{
//	kal_uint16 get_byte = 0;
//	char pusendcmd[2] = {(char)(OV64B40_MODULE_ID_OFFSET >> 8), (char)(OV64B40_MODULE_ID_OFFSET & 0xFF)};
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
   // kal_uint16 ov64b4040_id = 0;
	//prize add by lipengpeng 20200215 start
//		ov64b4040_id = read_module_id_ov64b4040();
//	printk("lppxxxx,ov64b4040_id=%x",ov64b4040_id);
//	if(ov64b4040_id !=0x69){
//		
...
//	}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			pr_info("ov64b40 i2c write id111: 0x%x\n", *sensor_id);
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		pr_info("ov64b40 get_imgsensor_id: 0x%x fail\n", *sensor_id);
