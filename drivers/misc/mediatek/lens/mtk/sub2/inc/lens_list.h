...
#define AW86017CSRAF_SetI2Cclient AW86017CSRAF_SetI2Cclient_Sub2
#define AW86017CSRAF_Ioctl AW86017CSRAF_Ioctl_Sub2
#define AW86017CSRAF_Release AW86017CSRAF_Release_Sub2
#define AW86017CSRAF_PowerDown AW86017CSRAF_PowerDown_Sub2
#define AW86017CSRAF_GetFileName AW86017CSRAF_GetFileName_Sub2
extern int AW86017CSRAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long AW86017CSRAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int AW86017CSRAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int AW86017CSRAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
