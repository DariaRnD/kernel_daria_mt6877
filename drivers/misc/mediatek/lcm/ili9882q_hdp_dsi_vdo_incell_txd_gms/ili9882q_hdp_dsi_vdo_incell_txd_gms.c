...
//prize add focal toucp gesture by yangcong  20201221 begin
	if(ilitek_is_gesture_wakeup_enabled() == false) {
    	printk("ili9882q----gesture disable\n");
...
struct LCM_DRIVER ili9882q_hdp_dsi_vdo_incell_txd_gms_lcm_drv =
{
    .name			= "ili9882q_hdp_dsi_vdo_incell_txd_gms",
#if defined(CONFIG_PRIZE_HARDWARE_INFO) && !defined (BUILD_LK)
	.lcm_info = {
		.chip	= "ili9882q_hdp_gms",
		.vendor	= "txd",
		.id		= "0x82",
		.more	= "720*1600",
	},
