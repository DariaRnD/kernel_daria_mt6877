...
{0x06,01,{0x9D}},     // Internal Line Time (RTN)
{0x0B,01,{0xA0}},     // Internal VFP[9]
{0x0C,01,{0x00}},     // Internal VFP[8]
{0x0D,01,{0x14}},     // Internal VBP ( ≦ 255 )
{0x0E,01,{0xDC}},     // Internal VFP  ( ≦ 1023 )
...
{0x63,01,{0x7E}},     // GVDDN = -5V
{0x64,01,{0x7E}},     // GVDDP = 5V
{0x68,01,{0xA1}},     // VGHO = 15V
{0x69,01,{0xA7}},     // VGH = 16V
{0x6A,01,{0xA1}},     // VGLO = -12V
{0x6B,01,{0x93}},     // VGL = -13V
{0x85,01,{0x37}},
{0x23,01,{0x42}},
{0x24,01,{0x52}},
...
{0xD9,01,{0x1F}},     // 4Lane
{0xC0,01,{0xA0}},     // NL = 1440
{0xC1,01,{0x15}},     // NL = 1440
{0x80,01,{0x09}},
...
{0xE0,27,{0x00,0x00,0x63,0x9C,0xDF,0x55,0x13,0x3A,0x68,0x8C,0xA5,0xC5,0xF1,0x19,0x3F,0xAA,0x68,0x9A,0xBA,0xE4,0xFF,0x07,0x36,0x6E,0x9E,0x03,0xEC}},
{0xE1,27,{0x00,0x00,0x63,0x9C,0xDF,0x55,0x13,0x3A,0x68,0x8C,0xA5,0xC5,0xF1,0x19,0x3F,0xAA,0x68,0x9A,0xBA,0xE4,0xFF,0x07,0x36,0x6E,0x9E,0x03,0xEC}},
...
{0x13,01,{0x14}},     // LV mode TSHD Rise position
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.PLL_CLOCK                = 297;//300;//258;
...
struct LCM_DRIVER ili9882q_hdp_dsi_vdo_incell_huaying_gms_lcm_drv =
{
    .name			= "ili9882q_hdp_dsi_vdo_incell_huaying_gms",
#if defined(CONFIG_PRIZE_HARDWARE_INFO) && !defined (BUILD_LK)
	.lcm_info = {
		.chip	= "ili9882q_gms_hdp",
		.vendor	= "huaying_gms",
		.id		= "0x82",
		.more	= "720*1440",
	},
