...
#endif /*CONFIG_SEC_NFC_WAKE_LOCK*/
#include <linux/of_gpio.h>
#include <linux/clk.h>

/* prize added by hanjiuping for nfc hardware info 2022/03/28 start */
#if defined(CONFIG_PRIZE_HARDWARE_INFO)
#include "hardware_info.h"

extern struct hardware_info current_nfc_info;
#endif
/* prize added by hanjiuping for nfc hardware info 2022/03/28 end */
...
/* prize added by hanjiuping for nfc hardware info 2022/03/28 start */
    ...
    sprintf(current_nfc_info.id,    "0x%04x", client->addr);
