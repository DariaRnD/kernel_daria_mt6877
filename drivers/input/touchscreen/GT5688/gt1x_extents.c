...
int  drv_ctp_num[DRV_CTP_GESTURE_NUM] = 
{
	...
	KEY_RIGHT,KEY_LEFT,KEY_DOWN,KEY_UP,KEY_U//yanrenjie modified to be the same as FocalTech TP 20190528
};
...
// add by lava yanrenjie begin
void gt1x_gesture_mode_set(int enable)
{
    gesture_enabled = enable;
    GTP_DEBUG("gesture mode en=%d", gesture_enabled);
}
